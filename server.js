...
const syntaxes = [
  ...
  1.  **キーワードの戦略的反復**
      ...
      **【重要】3文に1文は、必ず何らかのキーワードやフレーズを反復させてください。これは絶対的なルールです。**
      同じ言葉を異なる文脈で繰り返し、言葉の響きと印象を強調
  
  2.  **自明なことの再定義**
      当たり前の事実や概念を、新しい発見や深い洞察のように語る
      「〇〇とは、まさに〇〇である」という形式を必ず1回以上使用し、**この再定義においても、キーワードやその類義語を繰り返し用いてください（例：「食料とは、まさに食料であり、人間が生きるために食料が必要である、ということです」）。**
